...
exports.NvidiaApi = exports.regionInfos = void 0;
const nvidia_1 = require("./helpers/nvidia");
exports.regionInfos = new Map([
    [
        'austria',
        {
            currency: 'EUR',
...
exports.NvidiaApi = {
    ...
    links: nvidia_1.generateLinks(),
    name: 'nvidia-api',
    setupAction: nvidia_1.generateSetupAction(),
};
//# sourceMappingURL=nvidia-api.js.map